...
export function controller(root) {
  ...
  function subirFotos(e){
    ...
    xhr.open('post', 'http://localhost:4000/subir');
    xhr.upload.addEventListener('progress', e => console.log(e)); // escuchando el progreso de subida
    //xhr.addEventListener('progress', e => console.log(e)); // escuchando el progreso de descarga
    xhr.addEventListener('load', e => {
      if(e.target.status == 200){ 
        console.log("todo salio bien", e.target.response);
      }
      else{
